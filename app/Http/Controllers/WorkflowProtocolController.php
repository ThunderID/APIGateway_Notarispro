...
use App\Entities\WorkflowProtocol;

use League\Fractal\Manager;
use League\Fractal\Resource\Collection;

use App\Http\Transformers\WorkflowProtocolTransformer;

/**
 * WorkflowProtocol  resource representation.
 *
 * @Resource("WorkflowProtocol", uri="/companies")
 */
class WorkflowProtocolController extends Controller
{
	...
	public function post()
	{
		...
		{
			$result		= WorkflowProtocol::id($id)->first();
		}
		else
		{
			$result 	= new WorkflowProtocol;
		...
		$result->fill(Input::only('client_identifier', 'trigger', 'processes'));
	...
	{
		$rule 				= WorkflowProtocol::id(Input::get('_id'))->first();
	...
	{
		$fractal		= new Manager();
		$resource 		= new Collection($draft, new WorkflowProtocolTransformer);
